...
public class DrumKit implements MouseListener {
	...
	private void getGoing() throws MalformedURLException {
		...
		qwertyuiop.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		// 2. Make the frame visible and
		// set its default close operation to JFrame.EXIT_ON_CLOSE
		qwertyuiop.setSize(1000, 1000);
		// 3. Set the size of the frame
		qwertyuiop.setTitle("Default Title");
		// 4. Set the title to Default Title
		JPanel asdfghjkl = new JPanel();
		// 5. Make a JPanel variable and initialize it using "new JPanel().
		qwertyuiop.add(asdfghjkl);
		// 6. Add the panel to the frame. (The panel is invisible.)
		String zxcvbnm = "snare.jpg";
		drumLabelWithImage = createLabelImage(zxcvbnm);
		// 7. Download an image of a drum from the Internet. Drop it into your Eclipse
		// project under "default package".
		// 8. Put the name of your image in a String variable.
		asdfghjkl.add(drumLabelWithImage);
